          ...
          <tbody>
            ...
            <tr>
              <form>
                ...
                <td><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit<?= $r['id_rs'] ?>"><i class="fas fa-user-edit"></i></button></td>
                <td><a href="<?= base_url(); ?>admin/rs/hapus/<?= $r['id_rs'] ?>" type="button" class="btn btn-danger" onClick="return confirm('Apakah Anda Yakin?')" ><i class="fas fa-user-times"></i></a></td>
              </form>
            </tr>
            <!-- ubah -->
