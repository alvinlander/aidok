...
<div class="row">
  ...
  <div class="col-md-1"style="margin-top: 120px;" >
    <button class="ml-auto btn btn-secondary " type="button" onclick='btndisable()' name="button_chat" data-toggle="modal" data-target="#bayar<?=$d['id_dokter']?>" style="border-radius:13px;font-size:13px;background-color:#ec4638;border-color:#ec4638;">Chat</button>
  </div>
  <div class="col-md-1"style="margin-top: 120px;" >
    <button class="ml-auto btn btn-primary " type="button" name="button-janji-popup"data-toggle="modal" data-target="#bayar-janji<?=$d['id_dokter']?>" style="border-radius:13px;font-size:13px;background-color:#ec4638;border-color:#ec4638;">Buat Janji</button>
  </div>
