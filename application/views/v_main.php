...
<div class="container" style="margin-top: 20px;padding:10px;">
  ...
  <div class="carousel-inner" style="width: 40%; order: 0;">
    <div class="carousel-item active">
      <img class="d-block w-100" src="<?php echo base_url(); ?>Assets/sayur.png" alt="First slide" >
    </div>
...
<div class="container" style="margin-top: 10px;margin-bottom:150px;">
    ...
    <div class="card" style="width: 18rem;">
      ...
      <div class="card-body">
        <p> <strong>Janji Dengan Dokter</strong></p>
        <p class="card-text">Tepati janjimu bersama dokter.</p>
      </div>
</div>
<div class="card" style="width: 18rem;">
  <a href="<?= base_url('caridokter/')?>"></a>
  <center>
  <img class="card-img-top" src="<?php echo base_url(); ?>/Assets/finddoc.png" alt="Card image cap">
  </center>
  <div class="card-body">
