...
<body>
	<div class="topnav">
		<div class="container">
			<nav>
			<a href="<?= base_url('home/')?>" class="aidok">Aidok</a>
			<a href="<?= base_url('home/')?>">Home</a>
			<a href="<?= base_url('caridokter/')?>">Cari Dokter</a>
			<a href="<?= base_url('rumahsakit/')?>">Rumah Sakit</a>
			<a href="<?= base_url('about/')?>">Tentang Aidok</a>
        <div class="topnav-right">
		<a href="#" class="aboong"><?php $cek = $this->session->all_userdata();
		echo "Halo, ".$cek['user']['fullname'];?> </a>
				<div class="dropdown">
					...
					<div id="myDropdown" class="dropdown-content isidrop">
						...
						<a href="<?= base_url('home/logout')?>">Keluar</a>
					</div>
				</div>
