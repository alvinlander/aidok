...
class User extends CI_Controller {
    ...
    public function signup(){
        ...
        if ($this->form_validation->run() == false){
            ...
            $this->m_user->sendmail($email,"Registrasi Akun Aidok Berhasil !","Terima kasih telah mendaftarkan akun di Aidok!<br><br>E-mail ini menandakan bahwa E-mail anda telah terdaftar<br>");
            // $this->m_user->sendmail($email,"Keju Khas Malangnya KAKAK !","Terima kasih telah mendaftarkan akun di Aidok!<br><br>E-mail ini menandakan bahwa E-mail anda telah terdaftar<br>");
